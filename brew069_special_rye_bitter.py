...
b.ingredient('hops', 'fuggles', '1.35oz',
             time=Quantity('60min'), aa=Quantity('5%AA'))
b.ingredient('hops', 'fuggles', '0.8oz',
             time=Quantity('15min'), aa=Quantity('5%AA'))
b.ingredient('hops', 'fuggles', '0.6oz',
             time=Quantity('2min'), aa=Quantity('5%AA'))
