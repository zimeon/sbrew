...
b.ingredient('hops', 'amarillo', '0.4oz',
             time=Quantity('60min'), aa=Quantity('8.2%AA'))
b.ingredient('hops', 'willamette', '0.50oz',
             time=Quantity('60min'), aa=Quantity('5.2%AA'))
b.ingredient('hops', 'ekg', '0.50oz', time=Quantity(
    '60min'), aa=Quantity('6.4%AA'))
