...
b.ingredient('hops', 'amarillo', '1.25oz',
             time=Quantity('60min'), aa=Quantity('10.3%AA'))
b.ingredient('hops', 'hallertau', '0.50oz', time=Quantity(
    '0min'), aa=Quantity('4.1%AA'))  # no saaz left
