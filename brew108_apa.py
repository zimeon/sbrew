...
m = InfusionMash()
m.ingredient('grain','2-row','8.5lb',color='2L') #oops, should have been 10lb 
m.ingredient('grain','Munich','0.5lb',color='10L') #http://www.midwestsupplies.com/maillard-malts-briess-munich-malt-10l.html
...
b.ingredient('hops','Perle','1.8oz',time='60min',aa='5.3%AA')
