...
b.ingredient('hops', 'simcoe', '1.35oz',
             time=Quantity('60min'), aa=Quantity('13%'))
b.ingredient('hops', 'cascade', '1oz',
             time=Quantity('30min'), aa=Quantity('3.2%'))
b.ingredient('hops', 'centennial', '1oz',
             time=Quantity('10min'), aa=Quantity('9.9%'))
b.ingredient('hops', 'simcoe', '0.65oz',
             time=Quantity('0min'), aa=Quantity('13%'))
r.add(b)
